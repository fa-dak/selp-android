...
fun ContactDetailContent(contact: Contact) {
    ...
    Column(
        ...
        DetailInputItem(label = "나이", value = age, onValueChange = { age = it })
...
fun DetailInputItem(label: String, value: String, onValueChange: (String) -> Unit) {
    when (label) {
        ...
        else -> TextInputItem(label = label, value = value, onValueChange = onValueChange)
    }
}
...
@Composable
fun TextInputItem(label: String, value: String, onValueChange: (String) -> Unit) {
            ...
            BasicTextField(
                ...
                decorationBox = { innerTextField ->
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(top = 20.dp, bottom = 20.dp, end = 16.dp),
